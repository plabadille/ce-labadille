...
?>
	...
	function connect(){
		...
		jQuery.ajax({
			    type: "POST",  
				url:"<?php echo add_query_arg(array('action' => 'select_data_from_db_fmc', 'form_id' => $form_id, 'field_type' => $field_type, 'task' => 'db_tables', 'width' => '1000', 'height' => '500', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>",
	...
	if(product_name || product_price){
		...
		if(field_type =="checkbox" || field_type =="radio"){	
			...
			var el_choices_remove = document.createElement('img');
				...
				el_choices_remove.setAttribute("src", plugin_url + '/images/delete.png?ver=<?php echo WD_FMC_VERSION; ?>');
			...
			var el_choices_handle = document.createElement('img');
				...
				el_choices_handle.setAttribute("src", plugin_url + '/images/move_cursor.png?ver=<?php echo WD_FMC_VERSION; ?>');
...
<?php if($table_struct): ?>
	<div class="cols">
		...
		<div class="select-db-op where"><img src="<?php echo WD_FMC_URL . '/images/add_condition.png?ver='. WD_FMC_VERSION.''; ?>" title="ADD" class="add_cond"/>WHERE</div>
...
?>
	...
	jQuery("#tables").change(function (){
		...
		jQuery.ajax({
          type: "POST",
          url: "<?php echo add_query_arg(array('action' => 'select_data_from_db_fmc', 'form_id' => $form_id, 'field_type' => $field_type, 'task' => 'db_table_struct_select', 'width' => '1000', 'height' => '500', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>",
