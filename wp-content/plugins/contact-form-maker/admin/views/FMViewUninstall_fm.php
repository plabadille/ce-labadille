...
class FMViewUninstall_fmc {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////
	public function display() {
		...
		<form method="post" action="admin.php?page=uninstall_fmc" style="width:95%;">
          ...
          Note, that uninstalling Contact Form Maker will remove all forms, submissions and other data on the plugin.<br />Please make sure you don't have any important information before you proceed.
				</div>
				<p>
  ...
  public function uninstall() {
    ...
    $prefix = $wpdb->prefix;
    $addons = array('WD_FM_MAILCHIMP' => 'mailchimp', 'WD_FM_REG' => 'reg', 'WD_FM_POST_GEN' => 'post_gen_options', 'WD_FM_EMAIL_COND' => 'email_conditions', 'WD_FM_DBOX_INT' => 'dbox_int', 'WD_FM_GDRIVE_INT' => 'formmaker_gdrive_int', 'WD_FM_PDF' => array('pdf_options', 'pdf'), 'WD_FM_PUSHOVER' => 'pushover', 'WD_FM_SAVE_PROG' => array('save_options', 'saved_entries', 'saved_attributes'), 'WD_FM_STRIPE' => 'stripe', 'WD_FM_CALCULATOR' => 'calculator');
    $deactivate_url = add_query_arg(array('action' => 'deactivate', 'plugin' => WD_FMC_MAIN_FILE), admin_url('plugins.php'));
    $deactivate_url = wp_nonce_url($deactivate_url, 'deactivate-plugin_' . WD_FMC_MAIN_FILE);
    ?>
    ...
    <div class="wrap">
      ...
      <p><strong><a href="<?php echo $deactivate_url; ?>" class="cfm_deactivate_link" data-uninstall="1">Click Here</a> To Finish the Uninstallation and Contact Form Maker
